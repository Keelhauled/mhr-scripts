...
local function empty_pre_func(retval)
    return retval
end

sdk.hook(
    snow.gui.GuiSaveDataSelectMenu.isCharaEditable,
    empty_pre_func,
    function(retval) return sdk.to_ptr(true) end
)

sdk.hook(
    snow.gui.fsm.charamake.GuiCharamakePlayerFsmManager.checkUseEditPlayerTicket,
    empty_pre_func,
    function(retval) return sdk.to_ptr(false) end
)
